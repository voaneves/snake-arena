...
| ↳ **ACKTR — de onde vem o estouro da região de confiança** | — | `91_acktr_ablacoes.ipynb` | — | 🔬 **Resolvido, e a atribuição original estava certa**: as 5 execuções gravadas cobrem 46× de faixa de alvo e dão inclinação log–log de **0,58** — a região de confiança responde, com ganho sublinear de 6×–33×, que é a assinatura da Fisher subestimada. `tools/diag_acktr_kl.py --dos-registros` |
