...
| ↳ **ACKTR sem calibrar** — `kl_max` volta a ser alvo nominal | — | `98_acktr_ablacoes.ipynb` (braço `kl_do_paper`) | — | ✅ braço de controle: a mesma semente deu 83,91 e 64,53 em hardwares diferentes |
...
`RS` de `H` voltou, agora que o `VecSnake` expõe o potencial do shaping no `info`.

Com ele o LBC subiu para 42,77, e a autópsia seguinte ([§2.13](docs/LBC.md)) achou uma
membro **morta**: a política de γ = 0,999 sem shaping jogava sozinha a **2,03 pontos com
99% de fome** — ela aprendeu a andar em círculo, porque sob aquele γ não terminar vale mais
que jogar, e ainda assim assinava um terço de cada ação. O crítico não denunciava (`V₂` era
o *maior* dos três, e estava certo); só o retorno não descontado denuncia, que é o que o
bandit já media sem ninguém olhar. O [`90_lbc_populacao`](notebooks/90_lbc_populacao.ipynb)
carrega a `bala_de_prata` que junta as três correções, mais os braços que atribuem o que
valeu o quê.
...
| [`docs/LBC.md`](docs/LBC.md) | o LBC: as três peças, os desvios declarados em relação ao paper (um deles **revogado** na §2.2, quando a medição mostrou que o argumento estava errado), as três autópsias (§2.10, §2.11 e §2.13), a medição da população (§2.12) e o que olhar no log |
...
| ACKTR — as ablações | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/voaneves/snake-arena/blob/main/notebooks/98_acktr_ablacoes.ipynb) | [![Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)](https://kaggle.com/kernels/welcome?src=https://github.com/voaneves/snake-arena/blob/main/notebooks/98_acktr_ablacoes.ipynb) |
| MuZero — as ablações | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/voaneves/snake-arena/blob/main/notebooks/92_muzero_ablacoes.ipynb) | [![Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)](https://kaggle.com/kernels/welcome?src=https://github.com/voaneves/snake-arena/blob/main/notebooks/92_muzero_ablacoes.ipynb) |
